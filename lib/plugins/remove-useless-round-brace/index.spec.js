...
test('flatlint: remove-useless-round-brace: no-report: if', (t) => {
    t.transform('if');
    t.end();
});

test('flatlint: remove-useless-round-brace: no-report: getter', (t) => {
    t.noTransform('getter');
    t.end();
});

test('flatlint: remove-useless-round-brace: no-report: for-of', (t) => {
    t.transform('for-of');
    t.end();
});
