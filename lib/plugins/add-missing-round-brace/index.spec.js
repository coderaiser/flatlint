...
test('flatlint: add-missing-round-brace: transform: call-array', (t) => {
    t.transform('call-array');
    t.end();
});
...
test('flatlint: add-missing-round-brace: no report: if-call', (t) => {
    t.noReport('if-call');
    t.end();
});

test('flatlint: add-missing-round-brace: transform: malformed', (t) => {
    t.transform('malformed');
    t.end();
});

test('flatlint: add-missing-round-brace: transform: remove-useless-assign', (t) => {
...
test('flatlint: add-missing-round-brace: no transform: nested-object', (t) => {
    t.noTransform('nested-object');
    t.end();
});
