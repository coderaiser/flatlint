...
test('flatlint: convert-comma-to-semicolon: no report: array-colon', (t) => {
    t.noReport('array-colon');
    t.end();
});

test('flatlint: convert-comma-to-semicolon: no transform: import-with', (t) => {
    t.noTransform('import-with');
    t.end();
});
...
test('flatlint: convert-comma-to-semicolon: transform: arrow-newline', (t) => {
    t.transform('arrow-newline');
    t.end();
});
