...
import * as addMissingConst from './plugins/add-missing-const/index.js';
...
import * as applyDecoratorExport from './plugins/apply-decorator-export/index.js';
import * as applyDecoratorPrivate from './plugins/apply-decorator-private/index.js';
...
export const plugins = [
    ...
    ['add-missing-const', addMissingConst],
    ...
    ['apply-decorator-export', applyDecoratorExport],
    ['apply-decorator-private', applyDecoratorPrivate],
