...
test('flatlint: add-missing-round-braces: transform: if', (t) => {
    t.transform('if');
    t.end();
});

test('flatlint: add-missing-round-braces: no report: exists', (t) => {
    t.noReport('exists');
    t.end();
});

test('flatlint: add-missing-round-braces: no report: call-no-args', (t) => {
