...
test('flatlint: remove-useless-round-brace: report: fn', (t) => {
    t.report('fn', ['Remove useless round brace']);
    t.end();
});

test('flatlint: remove-useless-round-brace: no report: add-missing-squire-brace', (t) => {
    t.noReport('add-missing-squire-brace');
    t.end();
});
