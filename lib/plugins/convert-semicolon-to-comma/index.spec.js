...
test('flatlint: convert-semicolon-to-comma: no transform: fn', (t) => {
    t.noTransform('fn');
    t.end();
});

test('flatlint: convert-semicolon-to-comma: transform: chain', (t) => {
    t.transform('chain');
    t.end();
});

test('flatlint: convert-semicolon-to-comma: no transform: call-with-arg-object', (t) => {
    t.noTransform('call-with-arg-object');
    t.end();
});
