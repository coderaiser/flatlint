...
import * as applyImportFrom from '../apply-import-from/index.js';
...
test('flatlint: add-missing-comma: transform: method', (t) => {
    t.transform('method');
    t.end();
});
...
test('flatlint: add-missing-comma: no transform: class', (t) => {
    t.noTransform('class');
    t.end();
});

test('flatlint: add-missing-comma: no transform: declare', (t) => {
    t.noTransform('declare');
    t.end();
});

test('flatlint: add-missing-comma: no transform: import', (t) => {
    t.noTransform('import');
    t.end();
});

test('flatlint: add-missing-comma: no transform: export', (t) => {
    t.noTransform('export');
    t.end();
});

test('flatlint: add-missing-comma: no transform: broken-quote', (t) => {
    t.noTransform('broken-quote');
    t.end();
});

test('flatlint: add-missing-comma: transform: property', (t) => {
    t.transform('property');
    t.end();
});

test('flatlint: add-missing-comma: transform: apply-import-from', (t) => {
...
test('flatlint: add-missing-comma: no transform: tagged-template', (t) => {
    t.noTransform('tagged-template');
    t.end();
});

test('flatlint: add-missing-comma: no report: member', (t) => {
    t.noReport('member');
    t.end();
});

test('flatlint: add-missing-comma: no report: assign', (t) => {
    t.noReport('assign');
    t.end();
});

test('flatlint: add-missing-comma: no report: instanceof', (t) => {
    t.noReport('instanceof');
    t.end();
});
